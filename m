...
model
样式，型；模型，原型，模特儿；模范，典型
词根词缀： -mod- 模式 + -el 名词词尾
来源于拉丁语中 modus (量器)派生的 modulus (小量器)在通俗拉丁语中的变体 modellus, 经意大利语 modello 和早期现代法语 modelle 进入英语。
monitor
[ˈmɒnitə]显示屏，监视器，班长，监督员
词根词缀： mon- 提醒 , 警告 + -itor 名词词尾( o 略)
同根词monster怪物,最初指“神的警告”，词根mon表“警告
“怪物”的存在警醒你处境的危险。同样，“监视器”的存在警醒你不要不守纪律，有人在看你；老师不能整天呆在教室里，得找个学生当个监视器啊，就是班长了。
monitress
词根词缀： -mon- 提醒 , 警告 + -itor 名词词尾( o 略) + -ess 名词词尾 , 女性或雌性
monitoring
mustache
must
ache
